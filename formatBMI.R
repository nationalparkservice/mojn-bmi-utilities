...
#'
#' @param bmisites_url URL to read BMI site information (e.g., Park, Project, SiteCode, SiteName, SiteGroup) from AGOL feature layer. Defaults to URL current as of 2025
...
bmiSites <- fetchagol::fetchRawData(bmisites_url, agol_username, agol_password)
...
bmidata$BMI_SiteVisit <- bmidata$`Site & sample info` |>
  ...
  dplyr::select(SampleID, Laboratory, Park, Project, SiteCode, SiteName, SiteGroup, FieldSeason, AnalysisType, VisitID, COMID, WaterbodyName,
                NAMC_Latitude, NAMC_Longitude, Customer_Latitude, Customer_Longitude, CollectionDateText, Ecosystem, Habitat, SampleType, SamplerType,
